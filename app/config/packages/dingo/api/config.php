...
return [
    ...
    */
    ...
    'auth' => [
        'basic' => function ($app) {
            return new Dingo\Api\Auth\BasicProvider($app['auth'], 'username');
        }
    ],
    ...
    */
    ...
    'formats' => [
        ...
        // Override default formatter because we
        // don't want forward slashes escaped
        'json' => new Api\ResponseFormat\JsonResponseFormat
